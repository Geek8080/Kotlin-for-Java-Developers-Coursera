 ...
 * Implement the functions 'allNonZero' and 'containsZero' using
 * all three predicates in turn. 'allNonZero' checks that all the
 * elements in the list are non-zero; 'containsZero' checks that
 * the list contains zero element.
